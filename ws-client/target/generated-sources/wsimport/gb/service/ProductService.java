 ...
 * 
 */
@WebServiceClient(name = "ProductService", targetNamespace = "http://service.gb/", wsdlLocation = "http://localhost:8080/first-jsf-app/ProductService/ProductServiceImpl?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PRODUCTSERVICE_QNAME = new QName("http://service.gb/", "ProductService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/first-jsf-app/ProductService/ProductServiceImpl?wsdl");
    ...
    public ProductServiceWs getProductServiceImplPort() {
        return super.getPort(new QName("http://service.gb/", "ProductServiceImplPort"), ProductServiceWs.class);
    }
    ...
    public ProductServiceWs getProductServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.gb/", "ProductServiceImplPort"), ProductServiceWs.class, features);
    }
